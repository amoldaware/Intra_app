...
function loadHiddenPrincial(){
	var principalRepayment= document.getElementById("principalRepayment").value;
	document.getElementById("hiddenPrincipalRepayment").value=principalRepayment;
//	alert(principalRepayment);
}
function checkPrincipalRepayment(){
	
	var principalRepayment= document.getElementById("principalRepayment").value;
	var hiddenprincipalRepayment=document.getElementById("hiddenPrincipalRepayment").value;
	//alert("old principalRepayment"+hiddenprincipalRepayment+ "New principalRepayment"+principalRepayment);
	if(principalRepayment < hiddenprincipalRepayment){
		alert("Please enter Principal Repayment amount greater than "+hiddenprincipalRepayment);
		//document.getElementById("errPrincipalRepayment").innerHtml="Please enter Principal Repayment amount greater than "+hiddenprincipalRepayment;
		document.getElementById("principalRepayment").focus();
		return false;
		}else{
			document.getElementById("formClaimApplication").submit()
	return true;
}
	}
...
double npaPrincipalOutstanding = 0.0;
double npaIntrestOutstanding = 0.0;

String accntRestructred = null;
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="applicationReportDetails.do?method=applicationReportDetails"  method="POST" enctype="multipart/form-data">
		...
		<TR>
			...
			<TD>
				...
				<tr>
                  ...
                  <td class="tableData"> <div align="left">&nbsp; <b><%=str[5]%></div></td>
                </tr>
				<tr>
          ...
          System.out.println(newexpiredOn);
				...
				<tr>
                  <td class="tableData"> <div align="left">&nbsp; <b><bean:message key="ChiefPromoter" /></b><%=str[60]%></div></td>
        ...
        <tr>
        <td class="tableData"><b>&nbsp;<bean:message key="activitytype" /></b>:&nbsp;&nbsp;<%=str[17]%></div></td>
        <td class="tableData">&nbsp;</td>
				...
				<tr>
				  ...
				  <td class="tableData"><div align="left">&nbsp;<b><bean:message key="tcTenure" /></b>:&nbsp;&nbsp<%=str[47]%></div></td>
	...
	<html:form action="newMonthlyProgressReport.do?method=newMonthlyProgressReport" method="POST" enctype="multipart/form-data">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1">
                  <TR align="left" valign="top">
						...
						<TD width = "9%" align="left" class="ColumnBackground"> 
								Realised Date
									</TD>
						<TD width = "8%" align="left" class="ColumnBackground"> 
								Appr Date
...
<TABLE width="500" border="2" cellpadding="2" cellspacing="2">
	...
	<html:form action="newMonthlyProgressReport.do?method=newMonthlyProgressReport" method="POST" enctype="multipart/form-data">
			...
			<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="20%" class="Heading">ITPAN Details</TD>
												<TD><IMG src="images/TriangleSubhead.gif" width="19" height="19"></TD>
											</TR>
											<TR>
											<TD colspan="3" class="Heading"><IMG src="images/Clear.gif" width="5" height="5"></TD>
                ...
                <% 
						ArrayList iTpanList = null;
						String iTpanArray[]=null;						
						iTpanList=(ArrayList)request.getAttribute("iTpanArray");
				%> 
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <%	 for(int count=0;count<iTpanList.size();)
					{
                	iTpanArray=new String[7];			 
                	iTpanArray=(String[])iTpanList.get(count);			  
			   %>
	  
				
					<TR align="left" valign="top">
						<TD align="left" class="TableData"><%=iTpanArray[0]%></td>
						<TD align="left" class="TableData"><%=iTpanArray[1]%></td>
						<TD align="left" class="TableData"><%=iTpanArray[2]%></td>
						<TD align="left" class="TableData"><%=iTpanArray[3]%></td>
						<TD align="left" class="TableData"><%=iTpanArray[4]%></td>
						<TD align="left" class="TableData"><%=iTpanArray[5]%></td>
...
<TABLE width="500" border="2" cellpadding="2" cellspacing="2">
	...
	<html:form action="newMonthlyProgressReport.do?method=newMonthlyProgressReport" method="POST" enctype="multipart/form-data">
			...
			<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="20%" class="Heading">Disburse Morotorium Details</TD>
												<TD><IMG src="images/TriangleSubhead.gif" width="19" height="19"></TD>
											</TR>
											<TR>
											<TD colspan="3" class="Heading"><IMG src="images/Clear.gif" width="5" height="5"></TD>
                ...
                <% 
						ArrayList npaTcList = null;
						String npaTcArray[]=null;						
						npaTcList=(ArrayList)request.getAttribute("npaTcArray");
				%> 
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <%	 for(int count=0;count<npaTcList.size();)
					{
				 		npaTcArray=new String[13];			 
				 		npaTcArray=(String[])npaTcList.get(count);			  
			   %>
	  
				
					<TR align="left" valign="top">
						<TD align="left" class="TableData"><%=npaTcArray[0]%></td>
						<TD align="left" class="TableData"><%=npaTcArray[1]%></td>
						<TD align="left" class="TableData"><%=npaTcArray[2]%></td>
						<TD align="left" class="TableData"><%=npaTcArray[3]%></td>
						<TD align="left" class="TableData"><%=npaTcArray[4]%></td>
...
<html:form action="updateClaimApplication.do?method=updateClaimApplication" styleId="formClaimApplication" method="POST" >
  <table width="100%" border="0" cellspacing="0" cellpadding="0">    
    ...
    <tr> 
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  		...
  		<table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr> 
                    <td class="ColumnBackground"> <div align="left">&nbsp; <bean:message key="memberId"/>kk</div></td> 
                  ...
                  <tr> 
                    <td class="ColumnBackground"> <div align="left">&nbsp;Name of Borrower/unit</div></td>
                  ...
                  <tr>
					      	<td class="ColumnBackground"> <div align="left">&nbsp;Whether the Unit Assisted is an MICRO as per the MSMED Act 2006 definition of MSE:</td>
                  ...
                  <tr>
					      	<td class="ColumnBackground"> <div align="left">&nbsp;Internal Rating is of investment grade:</td>
						    <td class="TableData" colspan="3"> <div align="left"> &nbsp;<%=str[60]%></div></td>
                 </tr>
                  </tr>                
  				<tr> 
				                    ...
				                    <td colspan="4" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
				  					...
				  					<tr>
				  						...
				  						<td class="TableData" colspan="3">
				  							...
				  							<bean:write property="claimapplication.legalProceedingsDetails.amountClaimed" name="cpTcDetailsForm" format="##########.##" /></div>
                    ...
                    <td colspan="8" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                          ...
                          <td class="ColumnBackground" colspan="2"><div align="center" > &nbsp;<bean:message key="repayments"/></td>
                           <td class="ColumnBackground" colspan="2"><div align="center" > &nbsp;NPA Outstanding</td>
                         <!-- <td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;<bean:message key="outstandingasondateofnpa"/></td> --> 
  						...
  						<td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;Account Restructed or not</td>
  						<td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;Do you want claim for this Cgpan</td>
  					  </tr>
  					  <tr>
  					  ...
  					  <%
						 ...
						 lastDsbrsmntDtStr = "";
  					     ...
  					     //outstandingAsOnDateOfNPA = tlcldtl.getOutstandingAsOnDateOfNPA();
  					      npaPrincipalOutstanding = tlcldtl.getNpaPrincipalOutstanding();
  					    npaIntrestOutstanding =tlcldtl.getNpaIntrestOutstanding();
  					accntRestructred=tlcldtl.getAccountRestructred();
  					tcClaimFlag=tlcldtl.getTcClaimFlag();
  					  ...
  					  <tr>					  
  						  ...
  						  %>
  						  <td class="TableData">
  						<%--  	<html:text property="<%=principal%>" name="cpTcDetailsForm" styleId="principalRepayment" maxlength="16" size="10"  onkeypress="return decimalOnly(this, event,13);" onkeyup="isValidDecimal(this);" onchange="calOutstanding(this);"/>
  						<html:text property="" name="cpTcDetailsForm" styleId="principalRepayment" maxlength="16" size="10"  onkeypress="return decimalOnly(this, event,13);errorBlank('errPrincipalRepayment')" onkeyup="isValidDecimal(this);" onchange="calOutstanding(this);"/>--%>
  						 <div align="center">
  						 <input type="text" name="principalRepayment" value="<%=principalRepayment%>"  id="principalRepayment" />
  						
  						 <input type="hidden" name="hiddenPrincipalRepayment" value="<%=principalRepayment%>"  id="hiddenPrincipalRepayment" />
  						<input type="hidden" name="cgpan" value="<%=cgpan%>">
  							<%--<%=principalRepayment--%>
  							</div>
  						  </td>
  						  <%
  						...
  						<div align="center">   <input type="text" name="interestAndOtherCharges" value="<%=interestAndOtherCharges%>"  id="interestAndOtherCharges" />
  						  ...
  						  %>
  						  <td class="TableData">
  							<div align="right"><%=decimalFormat.format(npaPrincipalOutstanding)%></div>
  						  </td>
  						  <%
  						    interestCharges="tcInterestCharge(key-"+i+")";
  						  %>
  						  <td class="TableData">
  							<div align="right"><%=decimalFormat.format(npaIntrestOutstanding)%></div>  						  </td>
    ...
    <td class="TableData">
  							<div align="right"><%=accntRestructred%></div>
    </td>
      <td class="TableData">
  							<div align="right"><%=tcClaimFlag%></div>
    </td>
                  ...
                  <tr> 
                    <td colspan="5"><table width="100%" border="0" cellspacing="1">
  					...
  					<tr>
  						...
  						<td class="TableData"><div align="center">
  						<bean:write property="claimapplication.securityAndPersonalGuaranteeDtls.detailsAsOnDateOfSanction.valueOfOthers" name="cpTcDetailsForm" format="##########.##"/>
  				...
  				<tr> 
  					<td colspan="4"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  						...
  						<tr>
  							...
  							<td class="TableData"><div align="center">&nbsp;<%=cgpan%></div></td>
  							<td class="TableData"><div align="center">&nbsp;<%=decimalFormat.format(Double.valueOf(loanApprvd))%></div></td>
		...
		<tr>
		<td class="ColumnBackground">&nbsp;Date  of Claim Approved by Checker.</td>
		<td colspan="3" class="TableData" align="center"><bean:write property="claimapplication.claimCheckerDoneDatestr" name="cpTcDetailsForm"/></td>
		</tr>
		<tr>
		<td class="ColumnBackground">&nbsp;Latest Claim Updation.</td>
		<td colspan="3" class="TableData" align="center"><bean:write property="claimapplication.claimUpdationDateStr" name="cpTcDetailsForm"/></td>
		</tr>
		<tr>
    ...
    <tr> 
        ...
        <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
          <div>
            <div align="center">  
          <a onclick="return checkPrincipalRepayment();" >
            <img src="images/Save.gif" alt="Submit" width="49" height="37" border="0">
            </a>
          
            <%--<% System.out.println("Final Claim Ref Number:"+claimreferencenumber); 
            String url = "displayClaimRefNumberDtlsNew.do?method=displayClaimRefNumberDtlsNew&"+ClaimConstants.CLM_CLAIM_REF_NUMBER+"="+claimreferencenumber;
            <A href="<%=url%>">
      <!--    <a href="javascript:submitForm('displayClaimRefNumberDtls.do?method=displayClaimRefNumberDtls&ClaimRefNumber="<%=claimreferencenumber%>"')">   -->
